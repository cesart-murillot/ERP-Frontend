...
class ProductTransferDetailBloc extends Bloc<ProductTransferDetailEvent, ProductTransferDetailState> {
  ProductTransferDetailBloc() : super(const ProductTransferDetailState().init()) {
    on<InitEvent>(_init);
  }
